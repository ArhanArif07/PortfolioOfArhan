...
import { C as p, a as m, r as ne, t as re } from "./motion.yFoJz7cr.mjs";
import {
  B as h,
  C as g,
  Ct as _,
...
e(() => {
  (u(),
    ...
    (G = h(W)),
    (K = h(F)),
    (q = S(F, { nodeId: `pBR1Ew0r8`, override: pe, scopeId: `PX9hIOIVM` })),
    (J = ie(
      se(S(p.a, { nodeId: `HK2sXlagE`, override: fe, scopeId: `PX9hIOIVM` })),
    )),
    (Y = `framer-6jWyo`),
    ...
    (Se = ({ value: e, children: t }) => {
      ...
      return l(m.Provider, { value: a, children: t });
    }),
    (Z = p.create(n)),
    ...
    (Q = _(
      o(function (e, t) {
        let n = te(null),
          r = t ?? n,
          i = ee(),
          { activeLocale: a, setLocale: o } = le();
        ue();
        let { style: s, className: c, layoutId: u, variant: f, ...m } = Ce(e),
          {
            baseVariant: re,
            classNames: h,
            ...
            children: l(Se, {
              ...
              children: l(ce, {
                ...
                children: d(J, {
                  ...
                  __targetOpacity: 1,
                  className: `${v(S, `framer-n0ccwk`, c, h)} framer-bmpgw8`,
    ...
    ae(Q, [{ explicitInter: !0, fonts: [] }, ...G, ...K], {
...
//# sourceMappingURL=PX9hIOIVM.auf6V806.mjs.map
