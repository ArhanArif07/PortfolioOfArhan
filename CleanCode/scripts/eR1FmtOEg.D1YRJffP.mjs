...
var B,
  ...
  $ = e(() => {
    (l(),
      ...
      O(),
      k(),
      (B = [`KtoD4qpQL`, `HZqQEWd1Y`]),
      (V = `framer-oVNQ2`),
      (H = { HZqQEWd1Y: `framer-v-8nrskf`, KtoD4qpQL: `framer-v-1k3e98z` }),
      (U = (e) => {
      ...
      (q = { Alternative: `HZqQEWd1Y`, Tag: `KtoD4qpQL` }),
      (J = d.create(t)),
      (Y = ({
        color: e,
        fill: t,
        ...
        variant: q[c.variant] ?? c.variant ?? `KtoD4qpQL`,
      })),
      (X = (e, t) =>
            ...
            children: c(J, {
              ...
              children: c(K, {
                ...
                children: u(d.div, {
                  ...
                  style: {
                    "--hiiu6f": U(O),
                    borderBottomLeftRadius: W(E, 3),
                    borderBottomRightRadius: W(E, 2),
                    borderTopLeftRadius: W(E, 0),
                    borderTopRightRadius: W(E, 1),
                    ...m,
                  },
                  ...z(
                  ...
                  children: [
                    c(b, {
                      ...
                      style: {
                        ...
                        "--variable-reference-iijLKjEBG-eR1FmtOEg": w,
                      },
                      text: C,
      ...
      (Q = Z),
      (Z.displayName = `Tag`),
      (Z.defaultProps = { height: 34, width: 99 }),
      C(Z, {
        variant: {
        ...
        onG0ioNk51RChange: { changes: `G0ioNk51R`, type: w.ChangeHandler },
        iijLKjEBG: {
...
export { F as a, I as i, $ as n, R as o, L as r, Q as t };
//# sourceMappingURL=eR1FmtOEg.D1YRJffP.mjs.map
