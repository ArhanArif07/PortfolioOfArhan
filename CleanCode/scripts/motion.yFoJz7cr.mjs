  ...
  ke = t(() => {
    ((te = Object.create),
      ...
      (ve = (e, t, n, r, i) => ({
        ...
        metadata: r,
        addInitializer: (e) =>
          n._ ? se(`Already initialized`) : i.push(_e(e || null)),
      })),
        ...
        for (var y = r.length - 1; y >= 0; y--)
          ((l = ve(d, n, (c = {}), e[3], _)),
            d &&
              ...
              d ^ 3 &&
                (u.get = p
                  ? (e) => (d ^ 1 ? Te : Oe)(e, i, d ^ 4 ? a : v.get)
                  : (e) => e[n]),
              d > 2 &&
                (u.set = p
                  ? (e, t) => De(e, i, t, d ^ 4 ? a : v.set)
                  : (e, t) => (e[n] = t))),
            (s = (0, r[y])(
              d
                ? d < 4
      ...
      (Te = (e, t, n) => (
        Ce(e, t, `read from private field`),
        n ? n.call(e) : t.get(e)
      )),
      (Ee = (e, t, n) =>
        t.has(e)
...
function Re(e, t) {
  let n = !1,
    ...
    h = () => {
      ...
      ((n = !1),
        a ||
          (i.delta = r ? 1e3 / 60 : Math.max(Math.min(o - i.timestamp, fc), 1)),
        (i.timestamp = o),
        (i.isProcessing = !0),
        s.process(i),
        c.process(i),
...
function Ue(e) {
  return (
    isNaN(e) &&
    typeof e == `string` &&
    (e.match(Tc)?.length || 0) + (e.match(zc)?.length || 0) > 0
  );
}
function We(e) {
  let t = e.toString(),
...
function Ut(e) {
  for (let t = 0; t < e.length; t++)
    if (typeof e[t] == `string` && Gl.test(e[t])) return !0;
  return !1;
}
function Wt(e) {
  let {
...
function fn(e, t, { delay: n = 0, transitionOverride: i, type: a } = {}) {
  ...
  for (let t in c) {
    let i = e.getValue(t, e.latestValues[t] ?? null),
      a = c[t];
    if (a === void 0 || (p && dn(p, t))) continue;
    let s = { delay: n, ...Qt(o || {}, t) };
    ...
    if (r.MotionHandoffAnimation) {
      let n = un(e);
      if (n) {
        let e = r.MotionHandoffAnimation(n, t, B);
        e !== null && ((s.startTime = e), (m = !0));
      }
    }
    cn(e, t);
    let h = u ?? e.shouldReduceMotion;
    i.start(su(t, i, a, h && cu.has(t) ? { type: !1 } : s, e, m));
    let g = i.animation;
    g && f.push(g);
  }
  if (s) {
...
function yn(e, t, n) {
  ...
  for (; r < e.length && !i;) {
    let t = e[r];
    (typeof t == `string` && !ku.has(t) && We(t).values.length && (i = e[r]),
      r++);
  }
    ...
    i.forEach((e) => {
      ...
      (e.addEventListener(
        ...
        (n) => {
          ...
          let r = t(e, n);
          typeof r == `function` &&
            ((o = r), e.addEventListener(`pointerleave`, d, a));
        },
        a,
      ),
...
function Mn(e, t, n = {}) {
  let [i, a, o] = wn(e, n),
    s = (e) => {
      ...
      (Ru.add(i), n.stopPropagation && Bu.add(e));
      let o = t(i, e),
        s = (e, t) => {
          (r.removeEventListener(`pointerup`, c),
            r.removeEventListener(`pointercancel`, l),
            Ru.has(i) && Ru.delete(i),
            jn(e) && typeof o == `function` && o(e, { success: t }));
        },
        c = (e) => {
          s(
            e,
            i === r || i === document || n.useGlobalTarget || Pu(i, e.target),
          );
        },
        l = (e) => {
          s(e, !1);
        };
      (r.addEventListener(`pointerup`, c, a),
        r.addEventListener(`pointercancel`, l, a));
    };
  return (
    i.forEach((e) => {
      ((n.useGlobalTarget ? r : e).addEventListener(`pointerdown`, s, a),
        xn(e) &&
          (e.addEventListener(`focus`, (e) => zu(e, a)),
  ...
  return (
    ...
    () => {
      (Ku.delete(e),
        !Ku.size &&
          typeof qu == `function` &&
          (r.removeEventListener(`resize`, qu), (qu = void 0)));
    }
  );
}
function Bn(e, t) {
...
function Pr(e, t, n, r) {
  for (let n in (Tr(e, t, void 0, r), t.attrs))
    e.setAttribute(Sd.has(n) ? n : ln(n), t.attrs[n]);
}
function Fr(e, t, n) {
  let r = kr(e, t, n);
  for (let n in e)
...
function Kr(e, t, n, r = 0.5) {
  ((e.origin = r),
    ...
    ((e.translate >= Md && e.translate <= Nd) || isNaN(e.translate)) &&
      (e.translate = 0));
}
function qr(e, t, n, r) {
...
function di(e, t, n, r, i, a) {
  i
    ? ((e.opacity = J(0, n.opacity ?? 1, Bd(r))),
      (e.opacityExit = J(t.opacity ?? 1, 0, Vd(r))))
...
function yi(e) {
  ...
  if (r.MotionHasOptimisedAnimation(n, `transform`)) {
    ...
    r.MotionCancelOptimisedAnimation(n, `transform`, B, !(t || i));
  }
  let { parent: i } = e;
  i && !i.hasCheckedOptimisedAppear && yi(i);
}
function bi({
  ...
  return class {
      ...
      ((this.id = Yd++),
        ...
        (this.updateProjection = () => {
          ((this.projectionUpdateScheduled = !1),
            z.value &&
              (Kd.nodes =
                Kd.calculatedTargetDeltas =
                Kd.calculatedProjections =
                  0),
        ...
        this.options.animate !== !1 &&
          ...
          this.addEventListener(
            ...
            ({
              ...
              let i = this.options.transition || a.getDefaultTransition() || Xd,
              ...
              if (
                ...
                let t = { ...Qt(i, `layout`), onPlay: o, onComplete: s };
    ...
    startUpdate() {
      this.isUpdateBlocked() ||
        ((this.isUpdating = !0),
        this.nodes && this.nodes.forEach(Pi),
        this.animationId++);
    }
    ...
    willUpdate(e = !0) {
      ...
      if (
        (r.MotionCancelOptimisedAnimation &&
    ...
    applyTransform(e, t = !1, n) {
      ...
      return (
        ur(this.latestValues) &&
          br(r, this.latestValues, this.layout?.layoutBox),
        r
      );
    }
    removeTransform(e) {
    ...
    finishAnimation() {
      (this.currentAnimation &&
        (this.mixTargetDelta && this.mixTargetDelta(Jd),
        this.currentAnimation.stop()),
        this.completeAnimation());
    }
...
function oa({ children: e, isValidProp: t, ...n }) {
  ...
  return x($.Provider, { value: i, children: e });
}
...
function ua(e) {
  let { initial: t, animate: n } = la(e, y(_f));
  return l(() => ({ initial: t, animate: n }), [da(t), da(n)]);
}
function da(e) {
...
function ga(e, t, n, r) {
  let i = l(() => {
    let n = xf();
    return (
      Nr(n, t, Cd(r), e.transformTemplate, e.style),
...
function _a(e) {
  return typeof e != `string` || e.includes(`-`)
    ? !1
    : !!(Sf.indexOf(e) > -1 || /[A-Z]/u.test(e));
}
function va(e, t, n, { latestValues: r }, i, a = !1, s) {
  let c = ((s ?? _a(e)) ? ga : ha)(t, r, i, e),
    u = aa(t, typeof e == `string`, a),
    d = e === o ? {} : { ...u, ...c, ref: n },
    { children: f } = t,
    p = l(() => (X(f) ? f.get() : f), [f]);
  return _(e, { ...d, children: p });
}
function ya(e, t, n) {
  let r = b(n);
  w(() => {
...
function xa(e, t, n, i, a, o) {
  let { visualElement: s } = y(_f),
    c = y(ff),
    l = y(Fs),
    u = y($),
    f = u.reducedMotion,
  ...
  let x = n[hu],
    S = b(
      !!x &&
        r !== void 0 &&
        !r.MotionHandoffIsComplete?.(x) &&
        r.MotionHasOptimisedAnimation?.(x),
    );
  return (
    Ps(() => {
      ((h.current = !0),
...
function Sa(e, t, n, r) {
  ...
  ((e.projection = new n(
    e.latestValues,
    t[`data-framer-portal-id`] ? void 0 : Ca(e.parent),
  )),
...
function wa(e, { forwardMotionProps: t = !1, type: n } = {}, i, a) {
  i && na(i);
  let o = n ? n === `svg` : _a(e),
    s = o ? wf : Cf;
  function c(n, c) {
    ...
    if (!d && r !== void 0) {
      ...
      let t = Da(u);
      ((l = t.MeasureLayout),
        (f.visualElement = xa(e, p, u, a, t.ProjectionNode, o)));
    }
    return ee(_f.Provider, {
      value: f,
      children: [
        l && f.visualElement
          ? x(l, { visualElement: f.visualElement, ...u })
          : null,
        va(e, n, ya(p, f.visualElement, c), p, d, t, o),
      ],
    });
  }
...
function Oa(e, t) {
  ...
  return new Proxy((e, t) => r(e, t), {
    get: (i, a) =>
      a === `create`
        ? r
        : (n.has(a) || n.set(a, wa(a, void 0, e, t)), n.get(a)),
  });
}
function ka(e) {
...
function Ua(e, t) {
  ...
  return (
    i > r
      ? (n = Vs(t.min, t.max - r, e.min))
      : r > i && (n = Vs(e.min, e.max - i, t.min)),
    N(0, 1, n)
  );
}
function Wa(e, t) {
...
function to({ root: e, ...t }) {
  ...
  let r = Yf.get(n),
    i = JSON.stringify(t);
  return (
    r[i] || (r[i] = new IntersectionObserver(Zf, { root: e, ...t })),
    r[i]
  );
}
function no(e, t, n) {
...
function lo(e, t, n, r) {
  ...
  return (
    typeof e == `number`
      ...
      : typeof e == `string` &&
        ((e = e.trim()),
        (i = e.includes(` `) ? e.split(` `) : [e, cp[e] ? e : `0`])),
    (a = co(i[0], n, r)),
    (o = co(i[1], t)),
    a - o
  );
...
function ho(
  ...
  if (!t) return I;
  let a = mp.get(t);
  a || ((a = new Set()), mp.set(t, a));
  let o = mo(t, e, op(), i);
  if ((a.add(o), !fp.has(t))) {
    let e = () => {
        for (let e of a) e.measure(H.timestamp);
        B.preUpdate(n);
      },
      n = () => {
    ...
    (r.addEventListener(`resize`, i),
      t !== document.documentElement && pp.set(t, Bn(t, i)),
  ...
  return (
    ...
    () => {
      ...
      let i = gp.get(t);
      (i && (V(i), gp.delete(t)), hp.delete(t));
    }
  );
}
function go(e) {
  return r === void 0 ? !1 : e ? Il() : Fl();
}
function _o(e) {
...
function bo(e) {
  ...
  for (let [t, n] of vp)
    if (yo(e, t)) return { rangeStart: `${n} 0%`, rangeEnd: `${n} 100%` };
}
function xo(e) {
  let t = { value: 0 };
  return {
...
function ko(e, t) {
  return r === void 0 ? !1 : e ? Il() && !!bo(t) : Fl();
}
...
function Lo(e, t = {}) {
  ...
  if (n) return Po(r);
  let i = jo(r());
  return (w(() => Kn(i, e, t), [i, JSON.stringify(t)]), i);
}
function Ro(e, t = {}) {
        ...
        if (
          ...
          i &&
            ...
            h === `reverse` &&
              (o = [...r]
                .reverse()
                .map((e) => (typeof e == `function` ? Ys(e) : e))));
          for (let s = 0; s < m; s++) {
            let l = i && s % 2 == 0,
              d = l ? a : t,
              f = l ? o : r,
...
function gs(e) {
  tf.current &&
    ((tf.current.isUpdating = !1), tf.current.blockUpdate(), e && e());
}
function _s() {
  return u(() => {
    let e = tf.current;
...
function Cs(
  ...
  return x(s, {
    ...
    ref: p,
    ignoreStrict: !0,
    children: x(Np.Provider, { value: f, children: e }),
  });
}
function ws(e, t) {
...
function Os(e, t, n) {
  let i = t.getBoundingClientRect(),
    ...
    o =
      n === `x`
        ? Math.min(r.innerWidth, i.right)
        : Math.min(r.innerHeight, i.bottom),
    s = e - a,
    c = o - e;
  if (s < Fp) {
    let e = 1 - s / Fp;
...
function ks(e, t, n, i) {
  ...
  let a = Ds(e, n);
  if (!a) return;
  let { amount: o, edge: s } = Os(
    t - (n === `x` ? r.scrollX : r.scrollY),
    a,
    n,
  );
  if (s === null) {
    (zp.delete(a), Rp.delete(a));
    return;
  }
  let c = zp.get(a),
...
function js(
  ...
  return x(l, {
    ...
    onDrag: (e, t) => {
      ...
      (h(n, d[p].get(), r[p]), ks(g.current, a[p], p, r[p]), i && i(e, t));
    },
    onDragEnd: (e, t) => {
      (Ts(), a && a(e, t));
    },
  ...
  Hp = t(() => {
    (f(),
      ...
      (K = {
        ...
        parse: (e) =>
          jc.test(e) ? jc.parse(e) : Rc.test(e) ? Rc.parse(e) : Mc.parse(e),
        transform: (e) =>
          typeof e == `string`
            ? e
      ...
      (qc = (e, t) =>
        typeof e == `number` ? (t?.trim().endsWith(`/`) ? e : 0) : Kc(e)),
      (q = {
        test: Ue,
        parse: Ge,
      ...
      (Ml = class {
        ...
        scheduleResolve() {
          ((this.state = `scheduled`),
            this.isAsync
              ? (Ol.add(this),
                kl || ((kl = !0), B.read(Mt), B.resolveKeyframes(jt)))
        ...
        cancel() {
          this.state === `scheduled` &&
            (Ol.delete(this), (this.state = `pending`));
        }
        resume() {
      ...
      (Nl = (e) => e.startsWith(`--`)),
      (Pl = {}),
      (Fl = Ft(() => r.ScrollTimeline !== void 0, `scrollTimeline`)),
      (Il = Ft(() => r.ViewTimeline !== void 0, `viewTimeline`)),
      (Ll = Ft(() => {
        try {
          document
            .createElement(`div`)
      ...
      (Au = class extends Ml {
        ...
        readKeyframes() {
          ...
          if ((this.resolveNoneKeyframes(), !cu.has(n) || e.length !== 2))
            return;
          let [r, i] = e,
            a = vu(r),
            o = vu(i);
      ...
      (sd = class {
        ...
        bindToMotionValue(e, t) {
          ...
          let i = t.on(`change`, (t) => {
            ...
            a;
          (r !== void 0 &&
            r.MotionCheckAppearSync &&
            (a = r.MotionCheckAppearSync(this, e, t)),
            this.valueSubscriptions.set(e, () => {
              (i(), a && a());
            }));
        }
      ...
      (_d = class extends cd {
        ...
        readValueFromInstance(e, t) {
          if (Cl.has(t))
            return this.projection?.isProjecting ? Dt(t) : xl(e, t);
          {
            let n = Ar(e),
      ...
      (Zd = (e) =>
        T !== void 0 && T.userAgent && T.userAgent.toLowerCase().includes(e)),
      ...
      (nf = bi({
        ...
        defaultParent: () => {
          if (!tf.current) {
            let e = new $d({});
            (e.mount(r), e.setOptions({ layoutScroll: !0 }), (tf.current = e));
          }
          return tf.current;
        },
        resetTransform: (e, t) => {
      ...
      (af = ({
        ...
        return (
          ...
          x(Fs.Provider, { value: g, children: e })
        );
      }),
      (of = (e) => e.key || ``),
      (sf = ({
        ...
        if (m !== ee) {
          ...
          return (a === `wait` && E.length && (e = E), te(Zi(e)), w(m), null);
        }
              ...
              af,
              {
                ...
                onExitComplete: l
                  ...
                  : () => {
                      ...
                      if (S.has(s)) (C.current.add(s), S.set(s, !0));
                      else return;
                      let e = !0;
                      (S.forEach((t) => {
                        t || (e = !1);
      ...
      (lf = (e) => e === !0),
      (uf = (e) => lf(e === !0) || e === `id`),
      (df = ({ children: e, id: t, inherit: n = !0 }) => {
        let r = y(Ms),
          i = y(cf),
          [a, o] = $i(),
          s = b(null),
        ...
        s.current === null &&
          (uf(n) && c && (t = t ? c + `-` + t : c),
          (s.current = { id: t, group: (lf(n) && r.group) || Wi() }));
        let u = l(() => ({ ...s.current, forceRender: a }), [o]);
        return x(Ms.Provider, { value: u, children: e });
      }),
      (ff = c({ strict: !1 })),
      (pf = {
        animation: [
    ...
    ((_f = c({})),
        ...
        startScrollTracking(e) {
          ...
          (this.scrollPositions.set(r, { x: r.scrollX, y: r.scrollY }),
            ...
            (this.removeScrollListeners = () => {
              (r.removeEventListener(`scroll`, this.onElementScroll, {
                capture: !0,
              }),
      ...
      (Rf = class {
        ...
        startAxisValueAnimation(e, t) {
          ...
          return (
            ...
            n.start(su(e, n, 0, t, this.visualElement, !1))
          );
        }
        stopAnimation() {
        ...
        addListeners() {
          ...
          (a &&
            ...
            B.read(i));
          let s = hi(r, `resize`, () => this.scalePositionWithinConstraints()),
      ...
      (Vf = class extends ld {
        ...
        mount() {
          this.removePointerDownListener = Aa(
            this.node.current,
            `pointerdown`,
      ...
      (Wf = {
        pan: { Feature: Vf },
        drag: { Feature: zf, ProjectionNode: nf, MeasureLayout: Qa },
      }),
      (Gf = class extends ld {
        mount() {
      ...
      (hp = new WeakMap()),
      (gp = new WeakMap()),
      (_p = (e) => (e === document.scrollingElement ? r : e)),
      (vp = [
        [up.Enter, `entry`],
        [up.Exit, `exit`],
        [up.Any, `cover`],
...
//# sourceMappingURL=motion.yFoJz7cr.mjs.map
