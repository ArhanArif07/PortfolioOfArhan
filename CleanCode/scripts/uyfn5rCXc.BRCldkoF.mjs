...
import { N as t, q as n } from "./framer.uWP7Qtvw.mjs";
var r,
  i,
  a,
  o = e(() => {
    (n(),
      t.loadFonts([`GF;Fira Mono-500`, `GF;Fira Mono-700`]),
      (r = [
        {
          explicitInter: true,
          fonts: [
