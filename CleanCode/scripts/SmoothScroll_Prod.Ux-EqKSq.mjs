...
import { Ct as c, k as l, o as u, q as d } from "./framer.uWP7Qtvw.mjs";
function f(e, t, n) {
...
function b(e) {
  ...
  return (
    n(() => {
      if (i.current)
        try {
          i.current.scrollTo(0, { immediate: !0 });
        } catch (e) {
    ...
    n(() => {
      let e = () => {
        try {
          ...
          i.current && (e || n ? i.current.stop() : i.current.start());
        } catch (e) {
          ...
          if (r)
            try {
              ...
              e &&
                ...
                r.setAttribute(`data-lenis-prevent`, `true`);
            } catch (e) {
    ...
    n(() => {
      try {
        ...
        i.current = new v({ duration: (r || 10) / 10 });
        let e = (t) => {
            if (i.current)
              try {
                (i.current.raf(t), requestAnimationFrame(e));
              } catch (e) {
        ...
        return () => {
          if ((cancelAnimationFrame(t), i.current))
            try {
      ...
      try {
        ...
        let e = Array.from(document.querySelectorAll(`a[href]`) || [])
            .filter((e) => {
              ...
              if (!n.href) return !1;
              let r =
                  n.href.startsWith(t.location.origin) ||
                  n.href.startsWith(`./`) ||
                  n.href.startsWith(`/`),
                i = n.href.includes(`#`);
              return r && i;
            ...
            .map((e) => {
              try {
                let n = e,
                  r = n.href.includes(`#`) ? `#${n.href.split(`#`).pop()}` : ``,
                ...
                try {
                  if (i) {
                    ...
                    if (e) {
                      let n = t.getComputedStyle(e).scrollMarginTop;
                      a = (n && parseInt(n)) || 0;
                    }
                  }
                } catch (e) {
                ...
                return { href: r, scrollMargin: a, anchorElement: n };
              } catch (e) {
          ...
          n = (e, t, n) => {
            try {
              (e && e.preventDefault && e.preventDefault(),
                i.current && t && i.current.scrollTo(t, { offset: -(n || 0) }));
            } catch (e) {
              console.error(`Error in anchor click handler:`, e);
            }
          },
          r = e.map(
            ({ href: e, scrollMargin: t }) =>
              (r) =>
                n(r, e, t),
          );
        return (
...
//# sourceMappingURL=SmoothScroll_Prod.Ux-EqKSq.mjs.map
