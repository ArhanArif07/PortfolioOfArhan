var _a, _b;
const hostInfo = { version: "1357c82", scopeCanvas: JSON.parse("true") };
...
const projectId =
  (_a =
    projectMatch === null || projectMatch === undefined
      ? undefined
      : projectMatch.groups) === null || _a === undefined
    ? undefined
    : _a.id;
const projectAccessToken =
  ((_b =
    projectMatch === null || projectMatch === undefined
      ? undefined
      : projectMatch.groups) === null || _b === undefined
    ? undefined
...
const bootstrap = {
  ...
  hostInfo: { version: hostInfo.version },
};
if (projectId) {
